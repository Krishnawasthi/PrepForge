...
const DIFFICULTY_OPTIONS: { level: DifficultyLevel; label: string; desc: string; icon: React.ComponentType<{ className?: string }>; color: string }[] = [
  {
    level: "Easy",
    label: "Easy",
    desc: "Simple concepts and straightforward questions.",
    icon: Compass,
  ...
  },
  {
    level: "Medium",
    label: "Medium",
    desc: "Moderate concepts with practical interview scenarios.",
    icon: Gauge,
  ...
  },
  {
    level: "Hard",
    label: "Hard",
    desc: "Complex concepts, tricky cases, and deeper reasoning.",
    icon: Flame,
  ...
  },
  {
    ...
    desc: "A balanced mix of easy, medium, and hard questions.",
    icon: Shuffle,
